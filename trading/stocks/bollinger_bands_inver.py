...
if __name__ == '__main__':
    ...
    walk = WalkForwardAnalysis(estrategia = BB_estrategia(), class_dados = dados,
                               ...
                               nome_arquivo = rf"C:\Users\rafae\OneDrive\Documentos\Bolsa de Valores\Modelos_Quantitativos\PDFS_BACKTEST\analise_tecnica\backtest_2pra1_{acao}_BB_INVERTIDO.pdf",
