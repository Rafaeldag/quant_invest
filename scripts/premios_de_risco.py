...
#     premio = premio_risco(indicadores_dict,  liquidez = 1000000, nome_premio = 'MOMENTO_R6M', 
#                           caminho_dados=r'C:\Users\rafae\OneDrive\Documentos\Bolsa de Valores\Modelos_Quantitativos\base_dados_br',
#                           caminho_salvar_arquivo=r'C:\Users\rafae\OneDrive\Documentos\Bolsa de Valores\Modelos_Quantitativos\base_dados_br\premios_risco_br'
...
if __name__ == "__main__":
    ...
    for key, value in indicadores.items():
        ...
        elif key == "TAMANHO_VALOR_DE_MERCADO":
        
            indicadores_dict = {
                            'ValorDeMercado': 'crescente',
                            }
            
        elif key == "VALOR_EBIT_EV":
        
            indicadores_dict = {
                            'EBIT_EV': 'decrescente',
                            }
            
        elif key == "ALAVANCAGEM_EBIT_DL":
        
            indicadores_dict = {
                            'ebit_dl': 'decrescente',
                            }
            
        elif key == "PROPORCAO_VOLUME_20_200":
        
            indicadores_dict = {
                            'volume_medio_prop_20_200': 'decrescente',
                            }
        
        elif key == "MOMENTO_MM_7_40":
        ...
        premio = premio_risco(indicadores_dict,  liquidez = value, nome_premio = key, 
                            caminho_dados=r'C:\Users\rafae\OneDrive\Documentos\Bolsa de Valores\Modelos_Quantitativos\base_dados_br',
                            caminho_salvar_arquivo=r'C:\Users\rafae\OneDrive\Documentos\Bolsa de Valores\Modelos_Quantitativos\base_dados_br\premios_risco_br'
                            ) #não pode ter \ no nome!!
